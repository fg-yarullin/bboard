...
class Rubric(models.Model):
    ...
    super_rubric = models.ForeignKey('SuperRubric', on_delete=models.PROTECT, null=True, verbose_name='Надрубрика')
...
class Bb(models.Model):
    ...
    title = models.TextField(max_length=40, verbose_name='Товар')
